      ...
      <RideLayout title="Book Ride">
        <>
          ...
          <View className="flex flex-col w-full items-start justify-center mt-5">
            <View className="flex flex-row items-center justify-start mt-3 border-t border-b border-gray-100 w-full py-3">
          ...
          <Payment
           ...
           rideTime={driverDetails?.time! || 50} 
          />
        </>
      </RideLayout>
      </StripeProvider>
